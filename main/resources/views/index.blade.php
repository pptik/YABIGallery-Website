    ...
    <div class="pusher" style="height: 100%">
        <div class="ui container" style="width: 100% ;height: 100%">
            <div class="ui secondary pointing menu" style="padding: 5px" >
                <a href="{{url('/')}}">
                <img class="ui image" src="{{url('/')}}/main/resources/assets/images/tlitsbanner.png" style="height: 100px">
                </a>
                <div class="right menu">

                    <img class="ui  image" src="{{url('/')}}/main/resources/assets/images/logo_tlu.png">
                    <img class="ui  image" src="{{url('/')}}/main/resources/assets/images/lju-model.png">
                ...
                @section('js')
                    ...
                    var map = L.map('mymap').setView([-5.398449,105.266519], 10);
                    ...
                    iconUrl: "{{url('/')}}/main/resources/assets/images/tracerblue.png",
                    ...
                    map.setView([-5.398449,105.266519], 10);
                    }
                ...
                var div = L.DomUtil.create('div', 'info legend');
                div.innerHTML +=' <a class="ui item" onclick="click_location_bandarlampung()"><div class="ui button" style="background-color: rgba(0, 0, 0, 0.1);color: dodgerblue;font-weight: lighter;"><i class="location arrow icon"></i>Lampung</div></a>';
                div.innerHTML +=' <a class="ui item" onclick="onclick_map_setting()"><div class="ui button" style="background-color: rgba(0, 0, 0, 0.1);color: dodgerblue;font-weight: lighter;"><i class="setting icon"></i>Edit Map</div></a>';
